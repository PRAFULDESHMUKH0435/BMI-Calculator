        ...
        child: Column(
          ...
          children: [
            ExpansionTile(
              ...
              trailing: provider.isexpandedwhoweare ? const Icon(Icons.remove) : const Icon(Icons.add),
              children: const [
                Padding(
            ...
            ExpansionTile(
              ...
              trailing: provider.isexpandedaboutapp ? const Icon(Icons.remove) : const Icon(Icons.add),
              children: const [
                Padding(
                  padding: EdgeInsets.symmetric(horizontal: 14.0),
